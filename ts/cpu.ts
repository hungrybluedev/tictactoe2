import { checkVictory, lines, State } from "./definitions.js";
...
export const letCPUTakeAShot = (state: State, identifier: number): number => {
  ...
  // See if we need to panic (i.e. block an opponent from win)
